...
test('docs route lists every mounted backend endpoint', async () => {
  ...
  try {
    ...
    assert.deepEqual(endpointIds, [
      ...
      'GET /api/admin/blog/collections',
      'POST /api/admin/blog/collections',
      'PATCH /api/admin/blog/collections/:tag',
      'DELETE /api/admin/blog/collections/:tag',
      ...
      'GET /api/shop/filters/colors',
      'GET /api/shop/filters/sizes',
      'GET /api/shop/cart',
