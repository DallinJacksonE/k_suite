  ...
  endpoints: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'status', type: "'pending' | 'paid' | 'fulfilled' | 'shipped' | 'cancelled' | 'refunded'", location: 'body', required: true, description: 'New order status.' },
      ],
    ...
    },
    {
      ...
      summary: 'Issue an internal refund marker for an order and mark it refunded.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      fields: [
        { name: 'orderId', type: 'string', location: 'path', required: true, description: 'Order id to refund.' },
        { name: 'amount', type: 'number', location: 'body', required: false, description: 'Refund amount. Defaults to order charged amount.' },
        { name: 'reason', type: 'string', location: 'body', required: false, description: 'Internal refund note.' },
      ],
      responses: [{ status: 200, description: 'Order marked refunded.', body: '{ order: OrderRecord }' }],
    },
    {
      method: 'GET',
      path: '/api/admin/users',
      summary: 'List customer accounts with orders, purchased patterns, and account statistics.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      responses: [{ status: 200, description: 'Users returned.', body: '{ users: AdminUserAccount[] }' }],
    },
    {
      method: 'PATCH',
      path: '/api/admin/users/:email',
      summary: 'Edit customer account information such as name, notifications, password, and address book.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      fields: [
        { name: 'email', type: 'string', location: 'path', required: true, description: 'User email to edit.' },
        { name: 'name', type: 'string', location: 'body', required: false, description: 'Updated customer name.' },
        { name: 'emailNotificationsEnabled', type: 'boolean', location: 'body', required: false, description: 'Email notification preference.' },
        { name: 'password', type: 'string', location: 'body', required: false, description: 'Optional replacement password.' },
        { name: 'addressBook', type: 'UserAddressBook', location: 'body', required: false, description: 'Updated saved addresses.' },
      ],
      responses: [{ status: 200, description: 'User updated.', body: '{ user: AdminUserAccount }' }],
    },
    {
      method: 'DELETE',
      path: '/api/admin/users/:email',
      ...
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      fields: [{ name: 'email', type: 'string', location: 'path', required: true, description: 'User email to delete.' }],
    ...
    {
      method: 'GET',
      path: '/api/admin/blog/collections',
      summary: 'List blog collections for admin editing.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      responses: [{ status: 200, description: 'Blog collections returned.', body: '{ collections: BlogCollectionRecord[] }' }],
    },
    {
      method: 'POST',
      path: '/api/admin/blog/collections',
      ...
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      responses: [{ status: 201, description: 'Blog collection created.', body: '{ collection: BlogCollectionRecord }' }],
    },
    {
      method: 'PATCH',
      path: '/api/admin/blog/collections/:tag',
      summary: 'Update a blog collection.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      responses: [{ status: 200, description: 'Blog collection updated.', body: '{ collection: BlogCollectionRecord }' }],
    },
    {
      method: 'DELETE',
      path: '/api/admin/blog/collections/:tag',
      summary: 'Delete a non-default blog collection.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      responses: [{ status: 204, description: 'Blog collection deleted.' }],
    },
    {
      method: 'POST',
      path: '/api/admin/blog/articles',
    ...
    },
    {
      ...
      summary: 'List market dates for admin editing.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      responses: [{ status: 200, description: 'Market dates returned.', body: '{ events: MarketEvent[] }' }],
    },
    {
      method: 'POST',
      path: '/api/admin/markets',
      summary: 'Create an upcoming market date.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      fields: [
        { name: 'title', type: 'string', location: 'body', required: true, description: 'Market title.' },
        { name: 'location', type: 'string', location: 'body', required: true, description: 'Market location.' },
        { name: 'address', type: 'string', location: 'body', required: false, description: 'Street address used for Google Maps links/previews.' },
        { name: 'startsAt', type: 'string | Date', location: 'body', required: true, description: 'Market start date/time.' },
      ],
      responses: [{ status: 201, description: 'Market date created.', body: '{ event: MarketEvent }' }],
    },
    {
      method: 'PATCH',
      path: '/api/admin/markets/:eventId',
      summary: 'Update a market date.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      contentType: 'application/json',
      responses: [{ status: 200, description: 'Market date updated.', body: '{ event: MarketEvent }' }],
    },
    {
      method: 'DELETE',
      path: '/api/admin/markets/:eventId',
      summary: 'Delete a market date.',
      auth: 'Requires admin_cookie cookie or x-admin-cookie header.',
      responses: [{ status: 204, description: 'Market date deleted.' }],
    },
    {
      method: 'GET',
      path: '/api/blog/articles',
      summary: 'List published blog articles for the storefront.',
      auth: 'None.',
      responses: [{ status: 200, description: 'Published blog articles returned.', body: '{ articles: BlogArticleRecord[] }' }],
    },
    {
      method: 'GET',
      path: '/api/blog/collections',
      summary: 'List blog collections for the storefront.',
      auth: 'None.',
      responses: [{ status: 200, description: 'Blog collections returned.', body: '{ collections: BlogCollectionRecord[] }' }],
    },
    {
    ...
    {
      method: 'GET',
      path: '/api/user/purchased-patterns',
      summary: 'List purchased pattern metadata for the current user.',
      auth: 'Requires client_cookie.',
      responses: [{ status: 200, description: 'Purchased patterns returned.', body: '{ patterns: PurchasedPatternDownload[] }' }],
    },
    {
      method: 'POST',
      path: '/api/user/purchased-patterns/:productId/download',
      summary: 'Create a short-lived private pattern download link for an owned pattern.',
      auth: 'Requires client_cookie and CSRF token.',
      contentType: 'application/json',
      responses: [{ status: 200, description: 'Presigned pattern download returned.', body: 'PurchasedPatternDownload' }],
    },
    {
      method: 'GET',
      path: '/api/markets',
      summary: 'List upcoming market events.',
      auth: 'None.',
      responses: [{ status: 200, description: 'Market events returned.', body: 'MarketEventResponse' }],
    },
    {
      method: 'GET',
      path: '/api/markets/next',
      summary: 'Return the next upcoming market event.',
      auth: 'None.',
      responses: [{ status: 200, description: 'Next market event returned.', body: '{ nextEvent: MarketEvent | null }' }],
    },
  ],
};
